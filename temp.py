...
class TTTGame(object):
    ...
    def __str__(self):
        ...
        divs = ['\n---+---+---\n', '\n---+---+---\n', '\n']
        return ' ' + ' '.join(list(map(''.join, zip(rows, divs))))
    ...
    def next_move(self, piece):
        ...
        """
        if all(list(map(lambda x: len(set(x)) == 1, self.board))):
...
if __name__ == '__main__':
    print ('\n' * 100)
    print ("Welome to this TicTacToe game\n\n" +
           "Cells are numbered 1 to 9 which corresponds directly\n" +
